...
t_protocol_request() ->
  ?assertEqual(#{packet => <<0,0,0,14,0,1,0,0,0,0,0,0,0,4,116,101,115,116>>,
                 state => ?REQ_STATE2(1, 0)},
               kafe_protocol:request(1, <<>>, ?REQ_STATE2(0, 0))),
  ?assertEqual(#{packet => <<0,0,0,14,0,1,0,1,0,0,0,0,0,4,116,101,115,116>>,
                 state => ?REQ_STATE2(1, 1)},
               kafe_protocol:request(1, <<>>, ?REQ_STATE2(0, 1))),
  ?assertEqual(#{packet => <<0,0,0,14,0,1,0,2,0,0,0,0,0,4,116,101,115,116>>,
