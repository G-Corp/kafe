...
kafe_protocol_join_group_tests_test_() ->
  {setup,
   ...
   [
    ...
    fun() ->
        RQ = <<0, 0, 0, 0, 0, 1, 0, 16, 100, 101, 102, 97, 117, 108, 116, 95, 112, 114, 111, 116, 111, 99, 111, 108,
        ...
        ?assertEqual(
           ...
           kafe_protocol_join_group:response(RQ, #{api_version => 0})),
        ...
        ?assertEqual(
           {ok, #{error_code => none,
                 ...
                 members => [#{member_id => <<"kafe-9ca65ef4-65e8-4071-83e6-549862c173e0">>,
                               member_metadata => <<>>}],
                 protocol_group => <<"default_protocol">>}},
           kafe_protocol_join_group:response(RQ, #{api_version => 1}))
    end
   ]}.
